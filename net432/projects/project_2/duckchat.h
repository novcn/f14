...
/* Define codes for s2s types. These are messages sent inter-server. */
#define S2S_JOIN 8
#define S2S_LEAVE 9
#define S2S_SAY 10
...
struct s2s_say {
        ...
        int uid;//note I had issues with double having floating point errors and returning 0.0000 very often from random
